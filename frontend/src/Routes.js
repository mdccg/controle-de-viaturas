...
function Routes({ usuario = {}, token = '' }) {
  ...
  return (
    <Switch>
      ...
      <Route exact path="/revisoes"      component={updateManutencao && sudo ? HistoricoRevisoes    : Negado} />
      <Route exact path="/topicos"       component={updateManutencao && sudo ? GerenciadorTopicos   : Negado} />
      <Route exact path="/manutencoes"   component={updateManutencao && sudo ? HistoricoManutencoes : Negado} />
      ...
      <Route exact path="/checklist"     component={updateManutencao && logado ? Checklist : Negado} />
